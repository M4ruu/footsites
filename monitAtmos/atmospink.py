...
url = 'https://atmospink.co.id/products.json?limit=250'
discord_webhook_url = 'https://discord.com/api/webhooks/1131881100965335121/Fpt-dk-uU4YQvGjQ5LrPXFvVy6Tc42peWGV63_2aVzDU5XTYjeJ7M5S2xTNya6cWwtwZ'
data_file_path = 'atmospink.json'
proxy_list = []
...
def save_product_data(json_obj):
    with open('atmospink.json', 'w') as file:
...
def load_previous_products():
    ...
    with open('atmospink.json', 'r') as file:
        data = file.read()
